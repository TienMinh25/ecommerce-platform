...
type ProductAttribute struct {
	...
	Value         *AttributeOptionValue  `protobuf:"bytes,3,opt,name=value,proto3" json:"value,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSupplierProductResponse) GetSupplierId() string {
	if x != nil {
		return x.SupplierId
	}
	return ""
...
type GetProductDetailVariantResponse struct {
	...
	AttributeValues  []*VariantAttributePair `protobuf:"bytes,11,rep,name=attribute_values,json=attributeValues,proto3" json:"attribute_values,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GetProductReviewsResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetProductReviewsResponse) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *GetProductReviewsResponse) GetUserAvatarUrl() string {
	if x != nil {
...
func (x *GetProductReviewsResponse) GetRating() float32 {
	if x != nil {
		return x.Rating
	}
	return 0
...
func (x *GetProductReviewsResponse) GetComment() string {
	if x != nil {
		return x.Comment
	}
	return ""
...
func (x *GetProductReviewsResponse) GetHelpfulVotes() int64 {
	if x != nil {
...
func (x *GetProductReviewsResponse) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
var file_product_proto_rawDesc = string([]byte{
	...
	0x65, 0x12, 0x2b, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0xa6, 0x03, 0x0a, 0x1f, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x44, 0x65,
	...
	0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x40, 0x0a, 0x10, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x15, 0x2e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x50, 0x61, 0x69, 0x72, 0x52, 0x0f, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75,
	0x74, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x66, 0x0a, 0x14, 0x56, 0x61, 0x72, 0x69,
	0x61, 0x6e, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x50, 0x61, 0x69, 0x72,
	...
	0x22, 0x63, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65,
	...
	0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6c,
	...
	0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0x8b, 0x02, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f,
	...
	0x64, 0x41, 0x74, 0x42, 0x15, 0x5a, 0x13, 0x2e, 0x2f, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65, 0x72,
...
var file_product_proto_depIdxs = []int32{
	...
	12, // 1: GetProductsResponse.metadata:type_name -> PartnerMetadata
	...
	13, // 7: GetProductReviewsResponse.created_at:type_name -> google.protobuf.Timestamp
