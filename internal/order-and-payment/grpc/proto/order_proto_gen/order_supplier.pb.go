...
var file_order_supplier_proto_rawDesc = string([]byte{
	...
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2f, 0x6f, 0x72, 0x64, 0x65,
...
var file_order_supplier_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_order_supplier_proto_depIdxs = []int32{
	...
	3, // 1: GetSupplierOrdersResponse.metadata:type_name -> OrderMetadata
	4, // 2: SupplierOrdersResponse.estimated_delivery_date:type_name -> google.protobuf.Timestamp
	4, // 3: SupplierOrdersResponse.actual_delivery_date:type_name -> google.protobuf.Timestamp
