...
import { useDelivererSidebar } from '../../layout/DelivererLayout.jsx';
import useAuth from "../../../hooks/useAuth.js";

const DelivererSidebar = ({ onStateChange }) => {
    const {updateSidebarState} = useDelivererSidebar();
    ...
    // Menu items for deliverer - only order management
    const menuItems = [
        {icon: FiTruck, label: 'Quản lý giao hàng', path: '/deliverer/orders'},
    ];
