...
const VoucherSelector = ({ selectedVoucher, onVoucherSelect, cartTotal }) => {
    ...
    const handleApplyVoucher = () => {
        const selectedVoucherData = vouchers.find(v => v.id === selectedVoucherId);
                                            ...
                                            {vouchers.map((voucher) => {
                                                ...
                                                return (
                                                    <Box
                                                        ...
                                                        onClick={() => applicable && handleVoucherSelect(voucher.id)}
