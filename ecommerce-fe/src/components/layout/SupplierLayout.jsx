...
import SupplierSidebar from "../dashboard/supplier/SupplierSidebar.jsx";
import SupplierHeader from "../dashboard/supplier/SupplierHeader.jsx";
...
export const SupplierSidebarContext = createContext({
    isCollapsed: false,
...
export const useSupplierSidebar = () => useContext(SupplierSidebarContext);
...
const SupplierLayout = () => {
    ...
    // If user is not supplier, redirect to home page
    if (!isSupplier) {
    ...
    return (
        <SupplierSidebarContext.Provider value={contextValue}>
