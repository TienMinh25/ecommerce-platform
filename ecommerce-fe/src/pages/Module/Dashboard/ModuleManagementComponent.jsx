...
const ModuleManagementComponent = () => {
    ...
    // Load modules on page load and when pagination changes
    useEffect(() => {
        fetchModules();
                                    ...
                                    >
                                        ...
                                        <Td textAlign="right">
                                            <HStack spacing={1} justifyContent="flex-end">
                                                <Tooltip label="Edit module" hasArrow>
                                                    <IconButton
                                                ...
                                                <Tooltip label="Delete module" hasArrow>
                                                    <IconButton
...
export default ModuleManagementComponent;